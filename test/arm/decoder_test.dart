...
void main() {
  ...
  const [
    ...
    const Tuple2<int, String>(0xee070f9a, 'MCR'), // mcr  15, 0, r0, cr7, cr10, {4}
    const Tuple2<int, String>(0xe59f2038, 'LDR'), // ldr  r2, [pc, #56]
    const Tuple2<int, String>(0xe129f000, 'MSR'), // msr  CPSR_fc, r0
    const Tuple2<int, String>(0xee080f17, 'MCR'), // mcr  15, 0, r0, cr8, cr7, {0}
    const Tuple2<int, String>(0xe59f2038, 'LDR'), // ldr  r2, [pc, #56]
    const Tuple2<int, String>(0xe3c33001, 'BIC'), // bic  r3, r3, #1
    const Tuple2<int, String>(0xee013f10, 'MCR'), // mcr  15, 0, r3, cr1, cr0, {0}
